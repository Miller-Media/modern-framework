...
<label for="checkbox-<?php echo $field->name ?>">
	...
	<input type="checkbox" id="checkbox-<?php echo $field->name ?>" name="<?php echo $settings->getStorageId() ?>[<?php echo $field->name ?>]" value="1" <?php if ( $currentValue ) { echo 'checked="checked"'; } ?> /> 
